...
(function () {
  ...
  var BUTTON_BG = '#0b0b12';
  var GLASS_BG = 'radial-gradient(circle at 18% 22%, rgba(255,46,77,.9) 0, transparent 38%), radial-gradient(circle at 86% 78%, rgba(139,108,255,.9) 0, transparent 42%), #0b0b12';
  ...
  window.KIT = [
    ...
    { cat: 'Foundations', jp: '基', icon: 'palette', items: [
      { id: 'tokens-color', name: 'Color tokens', pad: '30px', note: 'Brand palette. Crimson is the action color, cyan and violet support it, gold for money and warnings.',
        html: '<div class="k-fcol">\n  <div class="sw" style="--c:#ff2e4d"><b>Crimson</b><span>#FF2E4D</span></div>\n  <div class="sw" style="--c:#27e1d6"><b>Cyan</b><span>#27E1D6</span></div>\n  <div class="sw" style="--c:#8b6cff"><b>Violet</b><span>#8B6CFF</span></div>\n  <div class="sw" style="--c:#ffc24b"><b>Gold</b><span>#FFC24B</span></div>\n  <div class="sw" style="--c:#ff5fb6"><b>Pink</b><span>#FF5FB6</span></div>\n  <div class="sw" style="--c:#a4ff6b"><b>Lime</b><span>#A4FF6B</span></div>\n  <div class="sw dk" style="--c:#f4f0e8"><b>Paper</b><span>#F4F0E8</span></div>\n  <div class="sw" style="--c:#07070b"><b>Night</b><span>#07070B</span></div>\n</div>',
...
.k-fcol .sw b { font: 700 13px 'Plus Jakarta Sans', sans-serif; }
.k-fcol .sw span { font-size: 11px; opacity: .8; }
.k-fcol .sw.dk { color: #07070b; }` },
      { id: 'tokens-type', name: 'Type scale', pad: '40px', note: 'Unbounded for display, Plus Jakarta Sans for reading, JetBrains Mono for data and code.',
        ...
        css: `.k-type { width: 600px; display: grid; gap: 16px; font-family: 'Plus Jakarta Sans', sans-serif; color: #f4f0e8; }
...
.k-type span { font: 500 11px 'JetBrains Mono', monospace; color: #7f7b93; text-transform: uppercase; letter-spacing: .1em; }
.k-type .d { font: 900 62px/1 'Unbounded', sans-serif; letter-spacing: -.04em; }
.k-type .h1 { font: 800 38px/1.05 'Unbounded', sans-serif; letter-spacing: -.03em; }
.k-type .h2 { font: 800 24px/1.1 'Unbounded', sans-serif; }
.k-type p { margin: 0; font-size: 16px; line-height: 1.6; color: #bdb8cc; }
.k-type code { font: 500 14px 'JetBrains Mono', monospace; color: #27e1d6; }` }
    ] },
  ...
  border: 1px solid rgba(255,255,255,.14); font-family: 'Plus Jakarta Sans', sans-serif; color: #f4f0e8; }
.k-hglass .logo { display: flex; align-items: center; gap: 10px; font: 800 18px 'Unbounded', sans-serif; letter-spacing: .06em; cursor: pointer; }
.k-hglass .logo i { width: 26px; height: 26px; border-radius: 8px; background: linear-gradient(135deg, #ff2e4d, #8b6cff); }
.k-hglass nav { display: flex; gap: 4px; margin: 0 auto; }
.k-hglass nav a { padding: 8px 14px; border-radius: 999px; font-size: 14px; color: #bdb8cc; cursor: pointer; transition: .3s; }
...
.k-hglass .ghost { padding: 10px 14px; font-size: 14px; color: #bdb8cc; cursor: pointer; }
.k-hglass .cta { padding: 11px 18px; border-radius: 999px; background: #ff2e4d; color: #fff; font-weight: 600;
  font-size: 14px; box-shadow: 0 8px 24px -8px #ff2e4d; cursor: pointer; transition: transform .3s; }
.k-hglass .cta:hover { transform: translateY(-2px); }` },
  ...
  background: #fbf6ee; color: #1b1b22; font-family: 'Plus Jakarta Sans', sans-serif; border-radius: 4px; }
...
.k-hsplit nav a:not(.book)::after { content: ''; position: absolute; left: 0; right: 0; bottom: -4px; height: 1.5px; background: #c8173a;
...
.k-hsplit .logo small { margin-top: 6px; font: 600 10px/1 'Plus Jakarta Sans', sans-serif; letter-spacing: .3em; color: #c8173a; }
.k-hsplit .book { padding: 10px 18px; border-radius: 999px; background: #1b1b22; color: #fbf6ee; font-weight: 600; }` },
      { id: 'hdr-shop', name: 'E-commerce header', note: 'Announcement strip, search with keyboard hint, icon actions with a cart badge, and a category row.',
        ...
        css: `.k-hshop { width: 980px; overflow: hidden; border-radius: 14px; background: #101018; color: #f4f0e8;
  font-family: 'Plus Jakarta Sans', sans-serif; border: 1px solid rgba(255,255,255,.1); }
.k-hshop .top { padding: 8px; text-align: center; font-size: 12px; background: #ff2e4d; color: #fff; }
.k-hshop .main { display: flex; align-items: center; gap: 24px; padding: 16px 22px; }
.k-hshop .logo { font: 800 22px 'Unbounded', sans-serif; cursor: pointer; }
.k-hshop .logo span { color: #ff2e4d; }
.k-hshop .s { flex: 1; display: flex; align-items: center; gap: 10px; height: 44px; padding: 0 14px; border-radius: 12px;
  background: rgba(255,255,255,.06); border: 1px solid rgba(255,255,255,.1); color: #7f7b93; }
.k-hshop .s:focus-within { border-color: #ff2e4d; }
...
.k-hshop .cart em { position: absolute; top: 4px; right: 3px; width: 17px; height: 17px; border-radius: 50%; display: grid; place-items: center;
  font: 700 10px 'JetBrains Mono', monospace; font-style: normal; background: #ff2e4d; color: #fff; }
.k-hshop nav { display: flex; gap: 4px; padding: 0 16px 12px; }
.k-hshop nav a { padding: 8px 12px; border-radius: 8px; font-size: 13.5px; color: #bdb8cc; cursor: pointer; }
.k-hshop nav a:hover, .k-hshop nav .on { color: #fff; background: rgba(255,255,255,.07); }
.k-hshop nav .sale { margin-left: auto; color: #ff2e4d; font-weight: 700; }` },
      { id: 'hdr-manga', name: 'Manga header', bg: 'radial-gradient(rgba(0,0,0,.14) 1px, transparent 1.3px) 0 0 / 8px 8px, #f4f0e8', note: 'Anime / manga style: ink borders, hard offset shadows, a hanko stamp logo and skewed hover states. The CTA physically presses in.',
  ...
  border: 3px solid #111; box-shadow: 8px 8px 0 #111; font-family: 'Unbounded', sans-serif; }
...
.k-hmanga .logo b { display: grid; place-items: center; width: 40px; height: 40px; background: #e8112d; color: #fff;
  font-family: 'Noto Serif JP', serif; transform: rotate(-8deg); border: 3px solid #111; }
...
.k-hmanga .cta:active { transform: translate(3px, 3px); box-shadow: 1px 1px 0 #111; }` },
      { id: 'hdr-app', name: 'Mobile app bar', bg: '#d9d9e4', note: 'App header for a 390px screen. The burger icon morphs on hover; filter chips switch on tap.',
        ...
        css: `.k-hmob { width: 390px; overflow: hidden; border-radius: 28px; background: #f3f3f7; color: #14141c; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-hmob header { display: flex; align-items: center; justify-content: space-between; padding: 18px 20px 6px; }
.k-hmob header b { font: 800 18px 'Unbounded', sans-serif; }
...
.k-hmob .av { width: 42px; height: 42px; border-radius: 50%; display: grid; place-items: center; font: 800 14px 'Unbounded', sans-serif; color: #fff;
  background: linear-gradient(135deg, #ff2e4d, #8b6cff); }
.k-hmob .t { padding: 10px 20px 20px; }
.k-hmob small { color: #8a8a99; font-size: 12.5px; }
.k-hmob h4 { margin: 4px 0 14px; font: 800 24px/1.1 'Unbounded', sans-serif; letter-spacing: -.02em; }
.k-hmob .chips { display: flex; gap: 6px; }
.k-hmob .chips button { height: 34px; padding: 0 16px; border: 0; border-radius: 17px; background: #fff; color: #555; font: 600 13px 'Plus Jakarta Sans', sans-serif; cursor: pointer; transition: .3s; }
.k-hmob .chips button.on { background: #14141c; color: #fff; }` }
  ...
  background: linear-gradient(100deg, #ff2e4d, #8b6cff); color: #fff; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-bann .tag { padding: 5px 10px; border-radius: 999px; background: #fff; color: #ff2e4d; font: 800 11px 'Unbounded', sans-serif; text-transform: uppercase; }
...
.k-btabs button { padding: 14px 16px; border: 0; background: none; color: #7f7b93; font: 600 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; transition: color .3s; }
.k-btabs button:hover, .k-btabs button.on { color: #fff; }
.k-btabs .ink { position: absolute; bottom: -1px; height: 2px; border-radius: 2px; background: #ff2e4d; box-shadow: 0 0 12px #ff2e4d;
...
.k-bseg button { position: relative; z-index: 1; height: 40px; padding: 0 20px; border: 0; background: none; color: #bdb8cc;
  font: 600 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; transition: color .3s; }
.k-bseg button.on { color: #07070b; }
.k-bseg em { font-style: normal; font-size: 11px; color: #22c55e; }
.k-bseg .ink { position: absolute; top: 5px; bottom: 5px; border-radius: 10px; background: #f4f0e8;
  transition: left .45s cubic-bezier(.16,1,.3,1), width .45s cubic-bezier(.16,1,.3,1); }` },
  ...
  border-radius: 26px; background: #0e0e15; border: 1px solid rgba(255,255,255,.08); font-family: 'Plus Jakarta Sans', sans-serif; }
.k-bnav a { display: grid; justify-items: center; gap: 4px; width: 60px; color: #7f7b93; font-size: 10.5px; font-weight: 600; cursor: pointer; transition: color .3s; }
.k-bnav a svg { transition: transform .4s cubic-bezier(.34,1.56,.64,1); }
.k-bnav a.on { color: #ff2e4d; } .k-bnav a.on svg { transform: translateY(-3px); }
.k-bnav .fab { width: 58px; height: 58px; margin-top: -34px; place-items: center; border-radius: 20px; color: #fff;
  background: linear-gradient(135deg, #ff2e4d, #8b6cff); box-shadow: 0 12px 26px -8px #ff2e4d; }
.k-bnav .fab.on { color: #fff; }` },
      { id: 'bar-side', name: 'Dashboard sidebar', note: 'Vertical navigation with an active indicator bar, count badge and an upgrade card.', js: 'tabs',
        ...
        css: `.k-bside { width: 240px; display: grid; gap: 2px; padding: 18px 12px; border-radius: 20px; background: #101018; color: #bdb8cc;
  font-family: 'Plus Jakarta Sans', sans-serif; border: 1px solid rgba(255,255,255,.08); }
.k-bside .lg { display: flex; align-items: center; gap: 10px; padding: 4px 10px 16px; font: 800 17px 'Unbounded', sans-serif; color: #fff; }
.k-bside .lg i { width: 26px; height: 26px; border-radius: 8px; background: linear-gradient(135deg, #27e1d6, #8b6cff); }
...
.k-bside a.on { background: rgba(255,46,77,.12); color: #fff; }
.k-bside a.on::before { content: ''; position: absolute; left: -12px; top: 10px; bottom: 10px; width: 3px; border-radius: 0 3px 3px 0; background: #ff2e4d; }
.k-bside em { margin-left: auto; font: 700 11px 'JetBrains Mono', monospace; font-style: normal; padding: 3px 7px; border-radius: 6px; background: #ff2e4d; color: #fff; }
.k-bside .up { display: grid; gap: 4px; margin-top: 16px; padding: 14px; border-radius: 14px; background: linear-gradient(135deg, rgba(255,46,77,.2), rgba(139,108,255,.2)); }
.k-bside .up b { color: #fff; font-size: 14px; } .k-bside .up small { font-size: 12px; }
.k-bside .up span { margin-top: 8px; padding: 8px; border-radius: 9px; text-align: center; background: #fff; color: #07070b; font-weight: 700; font-size: 13px; cursor: pointer; }` },
      { id: 'bar-steps', name: 'Checkout stepper', note: 'Progress stepper. Completed steps turn green, the current step pulses.',
        ...
        css: `.k-bstep { width: 620px; display: flex; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-bstep div { position: relative; flex: 1; display: grid; justify-items: center; gap: 10px; color: #7f7b93; font-size: 13px; font-weight: 600; }
...
.k-bstep .on i { background: #ff2e4d; border-color: #ff2e4d; animation: k-step 1.6s infinite; }
@keyframes k-step { 0% { box-shadow: 0 0 0 0 rgba(255,46,77,.6); } 100% { box-shadow: 0 0 0 14px rgba(255,46,77,0); } }` }
    ] },
    ...
    { cat: 'Heroes', jp: '顔', icon: 'image', items: [
      { id: 'hero-center', name: 'Centered SaaS hero', pad: '0', note: 'Gradient headline, announcement badge, dual CTAs and a logo strip. Badge arrow nudges on hover.',
        ...
        css: `.k-hero1 { width: 920px; display: grid; justify-items: center; gap: 22px; padding: 70px 40px 50px; text-align: center; color: #f4f0e8;
  font-family: 'Plus Jakarta Sans', sans-serif; background: radial-gradient(circle at 50% 0%, rgba(255,46,77,.35), transparent 60%), #0b0b12; }
...
.k-hero1 .badge b { padding: 4px 9px; border-radius: 999px; background: #ff2e4d; font-size: 11px; }
.k-hero1 .badge svg { transition: transform .3s; } .k-hero1 .badge:hover svg { transform: translateX(4px); }
.k-hero1 h2 { margin: 0; max-width: 760px; font: 800 52px/1.02 'Unbounded', sans-serif; letter-spacing: -.035em; }
.k-hero1 em { font-style: normal; background: linear-gradient(115deg, #ff2e4d, #ff5fb6, #8b6cff, #27e1d6); -webkit-background-clip: text; background-clip: text; color: transparent; }
.k-hero1 p { margin: 0; max-width: 560px; color: #bdb8cc; font-size: 17px; line-height: 1.6; }
...
.k-hero1 .p { background: #ff2e4d; color: #fff; box-shadow: 0 10px 30px -10px #ff2e4d; }
.k-hero1 .g { border: 1px solid rgba(255,255,255,.2); }
.k-hero1 .logos { display: flex; gap: 40px; margin-top: 20px; font: 800 18px 'Unbounded', sans-serif; color: rgba(255,255,255,.28); letter-spacing: .04em; }` },
  ...
  text-align: center; background: #fff; color: #111; font-family: 'Unbounded', sans-serif; }
...
.k-hero2 .stamp { position: absolute; right: 60px; top: 40px; padding: 10px 14px; font: 900 34px 'Noto Serif JP', serif; color: #fff; background: #e8112d;
...
.k-hero2 a:hover { transform: translate(-2px, -2px); box-shadow: 8px 8px 0 #e8112d; }` },
      { id: 'hero-split', name: 'Split hero with product mock', pad: '0', note: 'Copy and email capture on the left, an animated workflow mock on the right. Connector dashes flow continuously.',
        ...
        css: `.k-hero3 { width: 980px; display: grid; grid-template-columns: 1.1fr 1fr; gap: 30px; align-items: center; padding: 50px; background: #0e0e16; color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-hero3 .l { display: grid; gap: 16px; }
.k-hero3 small { font: 600 12px 'JetBrains Mono', monospace; color: #27e1d6; text-transform: uppercase; letter-spacing: .14em; }
.k-hero3 h2 { margin: 0; font: 800 42px/1.05 'Unbounded', sans-serif; letter-spacing: -.03em; }
.k-hero3 em { font-style: normal; color: #27e1d6; }
.k-hero3 p { margin: 0; color: #bdb8cc; font-size: 16px; }
...
.k-hero3 button { height: 44px; padding: 0 18px; border: 0; border-radius: 10px; background: #27e1d6; color: #062b28; font: 700 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }
.k-hero3 .note { display: flex; align-items: center; gap: 6px; font-size: 13px; color: #7f7b93; }
...
.k-hero3 path { fill: none; stroke: #27e1d6; stroke-width: 2; stroke-dasharray: 6 6; animation: k-flow 1s linear infinite; }
...
.k-hero3 .c { right: 18px; top: 122px; border-color: #8b6cff; color: #c9bbff; box-shadow: 0 0 24px rgba(139,108,255,.4); }` }
    ] },
  ...
  background: #ff2e4d; color: #fff; font: 600 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; box-shadow: 0 10px 30px -10px rgba(255,46,77,.8);
...
.k-b1:hover { transform: translateY(-2px); box-shadow: 0 16px 40px -10px #ff2e4d; }
...
.k-b1 svg { transition: transform .4s; } .k-b1:hover svg { transform: translateX(4px); }` },
      { id: 'btn-ghost', name: 'Ghost · liquid fill', bg: BUTTON_BG, note: 'An outlined button that fills from the bottom with a curved liquid edge that flattens as it rises.',
        ...
        css: `.k-b2 { position: relative; overflow: hidden; isolation: isolate; height: 52px; padding: 0 28px; border-radius: 999px; border: 1.5px solid #f4f0e8;
  background: transparent; color: #f4f0e8; font: 600 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; transition: color .4s; }
.k-b2::before { content: ''; position: absolute; inset: 0; z-index: -1; background: #f4f0e8; border-radius: 50% 50% 0 0;
  transform: translateY(101%); transition: transform .55s cubic-bezier(.16,1,.3,1), border-radius .55s; }
.k-b2:hover { color: #07070b; }
.k-b2:hover::before { transform: none; border-radius: 0; }` },
      { id: 'btn-neon', name: 'Neon pulse', bg: BUTTON_BG, note: 'Breathing neon glow (2.4s loop). Hover floods it with light.',
        ...
        css: `.k-b3 { height: 52px; padding: 0 30px; border-radius: 12px; border: 1.5px solid #27e1d6; background: rgba(39,225,214,.06); color: #27e1d6;
  font: 700 13px 'JetBrains Mono', monospace; letter-spacing: .14em; text-transform: uppercase; text-shadow: 0 0 10px #27e1d6;
  box-shadow: 0 0 12px rgba(39,225,214,.4), inset 0 0 12px rgba(39,225,214,.2); cursor: pointer; animation: k-b3 2.4s ease-in-out infinite; transition: background .3s, color .3s; }
.k-b3:hover { background: #27e1d6; color: #062b28; text-shadow: none; box-shadow: 0 0 40px #27e1d6; }
@keyframes k-b3 { 50% { box-shadow: 0 0 24px rgba(39,225,214,.75), inset 0 0 16px rgba(39,225,214,.3); } }` },
...
.k-b4 { position: relative; isolation: isolate; height: 52px; padding: 0 28px; border: 0; border-radius: 14px; background: #0b0b12; color: #fff;
...
.k-b4::before { content: ''; position: absolute; inset: -2px; z-index: -2; border-radius: 16px;
  background: conic-gradient(from var(--k-a), #ff2e4d, #8b6cff, #27e1d6, #ffc24b, #ff2e4d); animation: k-b4 3s linear infinite; transition: filter .3s; }
.k-b4::after { content: ''; position: absolute; inset: 0; z-index: -1; border-radius: 14px; background: #0b0b12; }
...
@keyframes k-b4 { to { --k-a: 360deg; } }` },
      { id: 'btn-slash', name: 'Anime slash', bg: BUTTON_BG, note: 'A skewed crimson blade wipes across on hover (450ms ease-in-out) — straight out of an anime title card.',
        ...
        css: `.k-b5 { position: relative; overflow: hidden; height: 54px; padding: 0 36px; border: 2px solid #f4f0e8; background: transparent; color: #f4f0e8;
  font: 800 13px 'Unbounded', sans-serif; letter-spacing: .08em; text-transform: uppercase; cursor: pointer;
  clip-path: polygon(12px 0, 100% 0, calc(100% - 12px) 100%, 0 100%); transition: border-color .3s; }
.k-b5::before { content: ''; position: absolute; top: -20%; bottom: -20%; left: -30%; width: 0; background: #ff2e4d; transform: skewX(-24deg);
  transition: width .45s cubic-bezier(.77,0,.175,1); }
.k-b5 span { position: relative; }
.k-b5:hover { border-color: #ff2e4d; }
.k-b5:hover::before { width: 160%; }` },
      { id: 'btn-3d', name: '3D press', bg: BUTTON_BG, note: 'Tactile: raised on hover, sinks fully when pressed (100ms).',
        ...
        css: `.k-b6 { height: 54px; padding: 0 30px; border: 0; border-radius: 14px; background: #ffc24b; color: #2a1a00; font: 800 15px 'Plus Jakarta Sans', sans-serif;
...
.k-b7 button { width: 52px; height: 52px; display: grid; place-items: center; border-radius: 50%; border: 1px solid rgba(255,255,255,.16);
  background: rgba(255,255,255,.04); color: #f4f0e8; cursor: pointer; transition: transform .45s cubic-bezier(.34,1.56,.64,1), background .3s, border-color .3s; }
.k-b7 button:hover { transform: scale(1.12) rotate(-8deg); background: #ff2e4d; border-color: #ff2e4d; }
.k-b7 .lk.on { background: #ff2e4d; border-color: #ff2e4d; }
.k-b7 .lk.on svg { fill: currentColor; }` },
      { id: 'btn-loading', name: 'Loading → success', bg: BUTTON_BG, note: 'Click it: collapses into a spinner, then turns green with a success label, then resets.', js: 'load',
        ...
        css: `.k-b8 { position: relative; height: 52px; min-width: 160px; padding: 0 26px; border: 0; border-radius: 12px; background: #8b6cff; color: #fff;
  font: 600 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; transition: min-width .4s, border-radius .4s, padding .4s, background .4s; }
...
@keyframes k-b8 { to { transform: rotate(1turn); } }` },
  ...
  color: #f4f0e8; font: 600 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }
.k-b9 .c { position: absolute; left: 0; top: 0; z-index: -1; width: 56px; height: 56px; border-radius: 28px; background: #ff2e4d;
...
.k-b9:hover .c svg { transform: translateX(4px); }` },
      { id: 'btn-split', name: 'Split button + menu', bg: BUTTON_BG, pad: '36px 36px 170px', note: 'Primary action with a caret that opens a menu on hover or keyboard focus (pure CSS :focus-within).',
        ...
        css: `.k-b10 { position: relative; display: inline-flex; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-b10 button { display: flex; align-items: center; gap: 8px; height: 48px; border: 0; background: #27e1d6; color: #062b28; font: 700 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }
...
.k-b10 li { padding: 9px 12px; border-radius: 8px; font-size: 13px; color: #bdb8cc; cursor: pointer; }
.k-b10 li:hover { background: rgba(255,255,255,.06); color: #fff; }` }
    ...
    { cat: 'Cards', jp: '札', icon: 'grid', items: [
      { id: 'card-product', name: 'Product card', note: 'Floating product orb, discount tag, wishlist toggle and an add button that spins on hover.', js: 'toggle',
        ...
        css: `.k-c1 { width: 270px; overflow: hidden; border-radius: 22px; background: #13131c; border: 1px solid rgba(255,255,255,.08); color: #f4f0e8;
  font-family: 'Plus Jakarta Sans', sans-serif; transition: transform .5s cubic-bezier(.16,1,.3,1); }
.k-c1:hover { transform: translateY(-6px); }
.k-c1 .img { position: relative; height: 220px; display: grid; place-items: center; background: radial-gradient(circle at 50% 45%, rgba(255,46,77,.35), transparent 60%), #0c0c14; }
.k-c1 .img i { width: 110px; height: 110px; border-radius: 50%; background: radial-gradient(circle at 35% 30%, #ff9aaa, #ff2e4d 50%, #6b0a1c);
...
.k-c1 .tag { position: absolute; left: 14px; top: 14px; padding: 5px 9px; border-radius: 8px; font: 700 11px 'JetBrains Mono', monospace; background: #ff2e4d; }
...
.k-c1 .w.on { background: #ff2e4d; border-color: #ff2e4d; } .k-c1 .w.on svg { fill: currentColor; }
.k-c1 .in { display: grid; gap: 6px; padding: 16px 18px 18px; }
.k-c1 small { font: 500 11px 'JetBrains Mono', monospace; color: #7f7b93; text-transform: uppercase; letter-spacing: .1em; }
.k-c1 h4 { margin: 0; font-size: 16px; }
.k-c1 .row { display: flex; justify-content: space-between; align-items: center; margin-top: 4px; }
.k-c1 b { font: 800 20px 'Unbounded', sans-serif; } .k-c1 s { font: 500 13px 'Plus Jakarta Sans', sans-serif; color: #7f7b93; }
.k-c1 .add { width: 40px; height: 40px; display: grid; place-items: center; border: 0; border-radius: 12px; background: #f4f0e8; color: #07070b; cursor: pointer;
...
.k-c1 .add:hover { transform: rotate(90deg) scale(1.08); }` },
      { id: 'card-pricing', name: 'Pricing card', note: 'Highlighted tier with a gradient border, ribbon, feature checklist and full-width CTA.',
        ...
        css: `.k-c2 { position: relative; width: 300px; display: grid; gap: 14px; padding: 28px 24px 24px; border-radius: 24px; color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif;
  background: linear-gradient(#13131c, #13131c) padding-box, linear-gradient(135deg, #ff2e4d, #8b6cff, #27e1d6) border-box; border: 1.5px solid transparent; }
.k-c2 .rib { position: absolute; top: -12px; left: 50%; transform: translateX(-50%); padding: 6px 12px; border-radius: 999px; font: 700 11px 'JetBrains Mono', monospace;
  text-transform: uppercase; letter-spacing: .08em; background: #ff2e4d; box-shadow: 0 8px 20px -6px #ff2e4d; }
.k-c2 small { font: 600 12px 'JetBrains Mono', monospace; color: #ff5fb6; text-transform: uppercase; letter-spacing: .14em; }
.k-c2 h4 { margin: 0; font: 800 40px 'Unbounded', sans-serif; } .k-c2 h4 span { font: 500 14px 'Plus Jakarta Sans', sans-serif; color: #7f7b93; }
.k-c2 p { margin: 0; color: #bdb8cc; font-size: 14px; }
...
.k-c2 a { display: grid; place-items: center; height: 48px; border-radius: 14px; background: #f4f0e8; color: #07070b; font-weight: 700; cursor: pointer; transition: .3s; }
.k-c2 a:hover { background: #ff2e4d; color: #fff; }` },
  ...
  border: 1px solid rgba(255,255,255,.08); color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; text-align: center; }
.k-c3 .cov { width: 100%; height: 90px; background: linear-gradient(120deg, #ff2e4d, #8b6cff 60%, #27e1d6); }
.k-c3 .av { width: 84px; height: 84px; margin-top: -42px; display: grid; place-items: center; border-radius: 50%; font: 800 28px 'Unbounded', sans-serif;
  background: #1f1f2e; border: 4px solid #13131c; box-shadow: 0 0 0 2px #ff2e4d; }
.k-c3 h4 { margin: 12px 0 2px; font-size: 18px; } .k-c3 p { margin: 0; font-size: 13px; color: #7f7b93; }
...
.k-c3 .st div { padding: 12px 0; display: grid; gap: 2px; } .k-c3 .st b { font: 800 16px 'Unbounded', sans-serif; } .k-c3 .st span { font-size: 11.5px; color: #7f7b93; }
...
.k-c3 .f { background: #ff2e4d; border-color: #ff2e4d !important; min-width: 106px; }
.k-c3 .f::after { content: 'Follow'; } .k-c3 .f.on { background: transparent; } .k-c3 .f.on::after { content: 'Following'; }` },
  ...
  color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-c4 .h { display: flex; justify-content: space-between; align-items: center; }
.k-c4 .h span { display: flex; gap: 8px; align-items: center; font-size: 13px; color: #bdb8cc; } .k-c4 .h svg { color: #ff2e4d; }
...
.k-c4 b { font: 800 32px 'Unbounded', sans-serif; letter-spacing: -.02em; }
.k-c4 small { font-size: 12.5px; color: #7f7b93; }
.k-c4 svg { width: calc(100% + 40px); height: 70px; margin: 10px -20px 0; }
.k-c4 .a { fill: rgba(255,46,77,.14); }
.k-c4 .l { fill: none; stroke: #ff2e4d; stroke-width: 2.5; stroke-dasharray: 400; stroke-dashoffset: 400; animation: k-draw 2s cubic-bezier(.16,1,.3,1) forwards infinite alternate; }
@keyframes k-draw { to { stroke-dashoffset: 0; } }` },
  ...
  border: 1px solid rgba(255,255,255,.2); color: #fff; font-family: 'Plus Jakarta Sans', sans-serif; box-shadow: 0 30px 60px -30px rgba(0,0,0,.6); }
...
.k-c5 h4 { margin: 4px 0 0; font: 800 20px 'Unbounded', sans-serif; }
...
.k-c5 a svg { transition: transform .3s; } .k-c5 a:hover svg { transform: translateX(4px); }` }
    ...
    { cat: 'Forms', jp: '書', icon: 'pen', items: [
      { id: 'form-float', name: 'Floating labels', note: 'Labels float up when the field is focused or filled — pure CSS using :placeholder-shown.',
        ...
        css: `.k-f1 { width: 380px; display: grid; gap: 14px; font-family: 'Plus Jakarta Sans', sans-serif; }
...
.k-f1 input:focus, .k-f1 textarea:focus { border-color: #ff2e4d; box-shadow: 0 0 0 4px rgba(255,46,77,.15); }
.k-f1 span { position: absolute; left: 16px; top: 16px; color: #7f7b93; font-size: 15px; pointer-events: none; transform-origin: left top; transition: transform .25s, color .25s; }
.k-f1 input:focus + span, .k-f1 input:not(:placeholder-shown) + span,
.k-f1 textarea:focus + span, .k-f1 textarea:not(:placeholder-shown) + span { transform: translateY(-10px) scale(.75); color: #ff2e4d; }
.k-f1 button { display: flex; align-items: center; justify-content: center; gap: 8px; height: 50px; border: 0; border-radius: 12px; background: #ff2e4d; color: #fff;
  font: 600 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }` },
      { id: 'form-command', name: 'Command palette', note: 'Ctrl + K style search with keyboard hints and a highlighted row. Arrow keys move the selection.', js: 'palette',
        ...
        css: `.k-f2 { width: 460px; overflow: hidden; border-radius: 18px; background: #14141d; border: 1px solid rgba(255,255,255,.12); color: #f4f0e8;
  font-family: 'Plus Jakarta Sans', sans-serif; box-shadow: 0 30px 60px -20px #000; }
.k-f2 label { display: flex; align-items: center; gap: 12px; padding: 16px 18px; border-bottom: 1px solid rgba(255,255,255,.08); color: #7f7b93; }
.k-f2 input { flex: 1; background: none; border: 0; outline: none; color: #fff; font: inherit; font-size: 16px; }
.k-f2 kbd { font: 500 11px 'JetBrains Mono', monospace; padding: 3px 7px; border-radius: 6px; border: 1px solid rgba(255,255,255,.18); color: #bdb8cc; }
.k-f2 ul { margin: 0; padding: 8px; list-style: none; }
.k-f2 li { display: flex; align-items: center; gap: 12px; padding: 11px 12px; border-radius: 10px; font-size: 14px; color: #bdb8cc; cursor: pointer; }
.k-f2 li span { flex: 1; }
.k-f2 li.on, .k-f2 li:hover { background: rgba(255,46,77,.14); color: #fff; }
.k-f2 li.on svg { color: #ff2e4d; }` },
      { id: 'form-toggles', name: 'Switches, checks & radios', note: 'Custom controls built on real inputs, so they stay keyboard- and screen-reader-friendly.',
        ...
        css: `.k-f3 { width: 300px; display: grid; gap: 14px; color: #f4f0e8; font: 500 14.5px 'Plus Jakarta Sans', sans-serif; }
...
.k-f3 .sw input:checked + i { background: #ff2e4d; } .k-f3 .sw input:checked + i::after { transform: translateX(20px); }
...
.k-f3 .cb input:checked + i { background: #27e1d6; border-color: #27e1d6; color: #062b28; }
...
.k-f3 .rd input:checked + i { border: 7px solid #8b6cff; }
.k-f3 input:focus-visible + i { outline: 2px solid #27e1d6; outline-offset: 3px; }` },
      { id: 'form-otp', name: 'OTP code input', note: 'Six boxes that auto-advance, support backspace and paste. Try typing digits.', js: 'otp',
        ...
        css: `.k-f4 { width: 400px; display: grid; justify-items: center; gap: 18px; text-align: center; color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-f4 p { margin: 0; color: #bdb8cc; font-size: 14px; } .k-f4 b { color: #fff; }
...
.k-f4 input { width: 52px; height: 62px; box-sizing: border-box; border-radius: 14px; border: 1.5px solid rgba(255,255,255,.15); background: rgba(255,255,255,.04);
  color: #fff; text-align: center; font: 800 24px 'Unbounded', sans-serif; outline: none; transition: .25s; }
.k-f4 input:focus { border-color: #ff2e4d; transform: translateY(-3px); box-shadow: 0 10px 20px -10px #ff2e4d; }
.k-f4 input.full { border-color: #27e1d6; }
.k-f4 button { width: 100%; height: 50px; border: 0; border-radius: 14px; background: #f4f0e8; color: #07070b; font: 700 15px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }` },
  ...
  color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-f5 h4 { margin: 0; font: 800 22px 'Unbounded', sans-serif; } .k-f5 p { margin: 0; color: #bdb8cc; font-size: 14px; }
...
.k-f5 input:focus { border-color: #8b6cff; }
.k-f5 button { height: 48px; padding: 0 20px; border: 0; border-radius: 12px; background: #8b6cff; color: #fff; font: 700 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }
.k-f5 small { display: flex; align-items: center; gap: 6px; font-size: 12.5px; color: #7f7b93; } .k-f5 small svg { width: 15px; height: 15px; }` }
    ] },
    ...
    { cat: 'Footers', jp: '足', icon: 'layers', items: [
      { id: 'foot-big', name: 'Multi-column footer', pad: '0', note: 'Brand block with newsletter, three link columns and a bottom bar with social icons.',
        ...
        css: `.k-ft1 { width: 980px; background: #0a0a10; color: #bdb8cc; font-family: 'Plus Jakarta Sans', sans-serif; border-top: 1px solid rgba(255,255,255,.08); }
.k-ft1 .top { display: grid; grid-template-columns: 1.6fr repeat(3, 1fr); gap: 30px; padding: 44px 40px; }
.k-ft1 .logo { display: flex; align-items: center; gap: 10px; font: 800 18px 'Unbounded', sans-serif; color: #fff; }
.k-ft1 .logo i { width: 26px; height: 26px; border-radius: 8px; background: linear-gradient(135deg, #ff2e4d, #8b6cff); }
...
.k-ft1 form button { width: 38px; height: 38px; display: grid; place-items: center; border: 0; border-radius: 9px; background: #ff2e4d; color: #fff; cursor: pointer; }
.k-ft1 h5 { margin: 0 0 14px; font: 600 11px 'JetBrains Mono', monospace; letter-spacing: .14em; text-transform: uppercase; color: #7f7b93; }
...
.k-ft1 .soc a:hover { background: #fff; color: #07070b; }` },
  ...
  background: #fbf6ee; color: #1b1b22; font-family: 'Plus Jakarta Sans', sans-serif; }
.k-ft2 .logo { font: 400 22px Georgia, serif; } .k-ft2 .logo b { font-weight: 700; color: #c8173a; }
...
.k-ft2 span { font: 500 12px 'JetBrains Mono', monospace; color: #7a7466; }` },
      { id: 'foot-manga', name: 'Manga “to be continued” footer', pad: '0', note: 'Ends the page like an episode: a huge slanted title, a stamp and a next-chapter arrow.',
        ...
        css: `.k-ft3 { position: relative; overflow: hidden; width: 900px; padding: 40px; background: #111; color: #fff; font-family: 'Unbounded', sans-serif;
...
.k-ft3 .stamp { position: absolute; right: 50px; top: 40px; width: 90px; height: 90px; display: grid; place-items: center; font: 900 50px 'Noto Serif JP', serif;
...
.k-ft3 .next:hover { transform: translate(-2px, -2px); box-shadow: 8px 8px 0 #e8112d; }` }
    ...
    { cat: 'Loaders', jp: '待', icon: 'refresh', items: [
      { id: 'load-ring', name: 'Gradient ring', bg: BUTTON_BG, note: 'Conic gradient masked into a ring. 1s linear rotation.',
        ...
        css: `.k-l1 { width: 56px; height: 56px; border-radius: 50%; background: conic-gradient(from 0deg, transparent, #ff2e4d);
...
.k-l2 i { width: 14px; height: 14px; border-radius: 50%; background: #27e1d6; animation: k-l2 .9s ease-in-out infinite; }
.k-l2 i:nth-child(2) { animation-delay: .15s; background: #8b6cff; } .k-l2 i:nth-child(3) { animation-delay: .3s; background: #ff2e4d; }
...
.k-l3 i { position: absolute; top: 0; bottom: 0; width: 40%; border-radius: 3px; background: linear-gradient(90deg, #ff2e4d, #8b6cff); animation: k-l3 1.3s cubic-bezier(.65,0,.35,1) infinite; }
@keyframes k-l3 { from { left: -40%; } to { left: 100%; } }` },
      { id: 'load-shuriken', name: 'Shuriken spin', bg: BUTTON_BG, note: 'A throwing star that spins and wobbles — the site’s signature loader.',
        ...
        css: `.k-l4 { color: #f4f0e8; filter: drop-shadow(0 0 12px rgba(255,46,77,.6)); animation: k-l4 .9s linear infinite; }
.k-l4 svg { display: block; }
@keyframes k-l4 { 0% { transform: rotate(0) scale(1); } 50% { transform: rotate(180deg) scale(.86); color: #ff2e4d; } 100% { transform: rotate(360deg) scale(1); } }` },
...
.k-l5 i { position: absolute; inset: 0; border-radius: 50%; border: 2px solid #27e1d6; animation: k-l5 1.8s ease-out infinite; }
.k-l5 i:nth-child(2) { animation-delay: .9s; }
.k-l5 b { width: 16px; height: 16px; border-radius: 50%; background: #27e1d6; box-shadow: 0 0 16px #27e1d6; }
...
.k-l7 i { position: absolute; left: 50%; top: 50%; width: 90px; height: 3px; margin: -1.5px 0 0 -45px; border-radius: 2px;
  background: linear-gradient(90deg, transparent, #fff 30%, #ff2e4d); box-shadow: 0 0 12px #ff2e4d; transform-origin: center; animation: k-l7 1.2s cubic-bezier(.77,0,.175,1) infinite; }
...
@keyframes k-l7 { 0% { transform: rotate(var(--r, 45deg)) scaleX(0); opacity: 0; } 40% { transform: rotate(var(--r, 45deg)) scaleX(1); opacity: 1; } 100% { transform: rotate(var(--r, 45deg)) scaleX(1) translateX(60px); opacity: 0; } }` },
      { id: 'load-glitch', name: 'Glitch text', bg: BUTTON_BG, note: 'RGB-split glitch using ::before/::after copies with clip-path slices.',
        ...
        css: `.k-l8 { position: relative; font: 900 30px 'Unbounded', sans-serif; letter-spacing: .08em; color: #f4f0e8; }
.k-l8::before, .k-l8::after { content: attr(data-t); position: absolute; inset: 0; }
.k-l8::before { color: #ff2e4d; animation: k-l8 1.6s infinite steps(2); clip-path: inset(0 0 55% 0); }
.k-l8::after { color: #27e1d6; animation: k-l8 1.3s infinite steps(2) reverse; clip-path: inset(55% 0 0 0); }
@keyframes k-l8 { 0% { transform: translate(0); } 25% { transform: translate(-3px, 1px); } 50% { transform: translate(3px, -1px); } 75% { transform: translate(-1px, 2px); } 100% { transform: translate(0); } }` }
    ...
    { cat: 'Feedback', jp: '報', icon: 'bell', items: [
      { id: 'fb-toasts', name: 'Toast notifications', note: 'Success and error toasts with a draining timer bar.',
        ...
        css: `.k-t { width: 360px; display: grid; gap: 10px; font-family: 'Plus Jakarta Sans', sans-serif; color: #f4f0e8; }
...
.k-t .ok span { background: rgba(34,197,94,.15); color: #22c55e; } .k-t .er span { background: rgba(255,46,77,.15); color: #ff2e4d; }
.k-t b { display: block; font-size: 14px; } .k-t small { font-size: 12.5px; color: #7f7b93; }
.k-t i { position: absolute; left: 0; bottom: 0; height: 3px; width: 100%; transform-origin: left; animation: k-tbar 4s linear infinite; }
.k-t .ok i { background: #22c55e; } .k-t .er i { background: #ff2e4d; }
@keyframes k-tin { from { opacity: 0; transform: translateX(30px); } }
@keyframes k-tbar { from { transform: scaleX(1); } to { transform: scaleX(0); } }` },
      { id: 'fb-modal', name: 'Confirm dialog', bg: 'rgba(4,4,8,.9)', note: 'Destructive-action modal: icon, clear consequence, and the safe option first.',
  ...
  border: 1px solid rgba(255,255,255,.12); color: #f4f0e8; font-family: 'Plus Jakarta Sans', sans-serif; text-align: center; box-shadow: 0 40px 80px -30px #000;
  animation: k-min .5s cubic-bezier(.16,1,.3,1); }
@keyframes k-min { from { opacity: 0; transform: translateY(20px) scale(.96); } }
.k-m .ic { width: 56px; height: 56px; display: grid; place-items: center; border-radius: 18px; background: rgba(255,46,77,.15); color: #ff2e4d; }
.k-m h4 { margin: 6px 0 0; font: 800 20px 'Unbounded', sans-serif; } .k-m p { margin: 0; font-size: 14px; color: #bdb8cc; line-height: 1.55; }
.k-m .a { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; width: 100%; margin-top: 10px; }
.k-m button { height: 46px; border-radius: 12px; font: 700 14px 'Plus Jakarta Sans', sans-serif; cursor: pointer; }
.k-m .c { border: 1px solid rgba(255,255,255,.16); background: none; color: #fff; }
.k-m .d { border: 0; background: #ff2e4d; color: #fff; }` },
      { id: 'fb-alerts', name: 'Inline alerts', note: 'Info, warning and success banners with icons and a left accent bar.',
        ...
        css: `.k-al { width: 440px; display: grid; gap: 10px; font-family: 'Plus Jakarta Sans', sans-serif; }
...
.k-al .i { background: rgba(39,225,214,.08); border-color: #27e1d6; color: #27e1d6; }
.k-al .w { background: rgba(255,194,75,.08); border-color: #ffc24b; color: #ffc24b; }
