...
(function () {
  ...
  var SEALS = [
    ...
    { id: 'lab', page: 'lab', k: '術', name: 'The Lab · Jutsu Dojo', href: 'showcase#dojo', sel: '#dojo .lab-info', riddle: 'Six chapters stand in a row. The first one breaks wood with lightning.', x: 40, y: 62 },
