...
(function () {
  ...
  var SEALS = [
    { id: 'home-1', page: 'home', k: '闇', name: 'The dark room', href: './#mystery', riddle: 'Where the lantern reaches last, something glints.', x: 12, y: 70 },
    { id: 'home-2', page: 'home', k: '扉', name: 'The sealed door', href: './#mystery', riddle: 'Behind three seals: storm, flame and moon.', x: 25, y: 38 },
    { id: 'lab', page: 'lab', k: '願', name: 'The Lab · Bingo Book', href: 'showcase#bingo', sel: '#bingo .lab-info', riddle: 'Ten chapters stand in a row. The last one keeps a book of the wanted.', x: 40, y: 62 },
    { id: 'kit', page: 'kit', k: '動', name: 'UI Kit · Motion', href: 'components#motion', sel: '#motion .kx-head', riddle: 'Where easing can be felt, look above the curve.', x: 52, y: 26 },
    { id: 'shop', page: 'shop', k: '店', name: 'Shop · the last word', href: 'shop', sel: '.shop-cta .section-head', riddle: 'After twelve stores, someone asks: want one like this?', x: 63, y: 70 },
    { id: 'demos', page: 'demos', k: '演', name: 'Demo sites · Built right', href: 'demos', sel: '.dm-inc .section-head', riddle: 'Not just pretty. Look where it is built right.', x: 72, y: 40 },
    { id: 'world', page: 'world', k: '里', name: 'Dev World · Git tower', href: 'dev-world#git', sel: '#git .section-head, #git h2', riddle: 'In the village, the tower remembers every commit.', x: 83, y: 66 },
    { id: 'hire', page: 'hire', k: '約', name: 'Hire · Payments', href: 'hire', sel: '#pay-t', riddle: 'The last seal waits where you choose how to pay.', x: 90, y: 24 }
  ];
