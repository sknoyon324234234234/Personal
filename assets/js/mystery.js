...
(function () {
  ...
  var SEALS = [
    ...
    { id: 'lab', page: 'lab', k: '願', name: 'The Lab · Wish wall', href: 'showcase#wishes', sel: '#wishes .lab-info', riddle: 'Ten chapters stand in a row. The last one hangs wishes on wood.', x: 40, y: 62 },
